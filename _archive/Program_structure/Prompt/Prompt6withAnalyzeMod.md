...
- **UI设计**: `.ui_design/ui_structure.md`, `.ui_design/component_library.md`, `.ui_design/design_system.md`
- **素材需求**: `.ui_design/asset_requirements.md`, `.ui_design/implementation_guide.md`
...
```
处理UI设计中的素材需求:
1. **素材检查**: 验证asset_requirements.md中列出的素材是否可用
